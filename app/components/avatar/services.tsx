...
const services = [
  ...
  {
    slug: 'klonirovanie-golosa',
    icon: '/assets/ai-voice.png',
    title: 'Клонирование голоса | ИИ-озвучка',
    description: 'Вы пишете текст, телеграмм бот или мы выдаём студийный звук для коротких и длинных видео, курсов и озвучек. Идеально для Reels, Short и длинных видео на YouTube',
    buttonColor: 'gray',
  },
];
