  ...
  const plans = [
    {
      ...
      features: [
        { text: 'Количество платформ - 3', checked: true },
      ],
    },
    {
      id: 'business',
      ...
      features: [
        { text: 'Количество платформ - 6', checked: true },
      ],
    },
    {
      id: 'corp',
      ...
      features: [
        { text: 'Количество платформ - безлимит', checked: true },
      ],
    },
  ];
...
<div className="flex flex-col gap-1 items-center">
  <p className={styles.forWho}> <span>Для кого:</span> </p>
  <p className={styles.forWho}>{plan.forwho}</p>
</div>

              <div className={styles.price}>{plan.price} <span className={styles.volute}>₽</span> </div>
              <div className="flex flex-col gap-1 items-center">
  <p className={styles.underT}> {plan.under} </p>
</div>
            </div>
          ))}
        </div>
        ...
        <p className={styles.support}>
          Включено: генерация до 3 постов в день для каждой сети + техническая поддержка от 10 000 ₽ в месяц.
          <br />
Возможна настройка отдельных соцсетей и кастомных сценариев.
