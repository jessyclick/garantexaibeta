      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <h1 className={styles.title}>
            <span className={styles.titleAccent}>Ведение соцсетей и</span>
            <br />
            автоматизация SMM
          ...
          <p className={styles.lead}>
            Превращаем соцсети в актив, который каждый день приводит клиентов — без SMM-специалистов и лишних расходов.
          </p>

          <div className={styles.features}>
            <div className={`${styles.featureBox} ${styles.featureBoxThird}`}>
              <span>Наша ИИ-система сама создаёт контент, адаптирует его под 7+ платформ и публикует по графику 24/7.</span>
            </div>
            <div className={`${styles.featureBox} ${styles.featureBoxSecond}`}>
              <span>Ваш бренд растёт органически — вы не тратите время и бюджет.</span>
            </div>
          </div>
