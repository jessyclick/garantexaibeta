...
const FAQ = () => {
  ...
  const faqItems: FAQItem[] = [
    {
      id: '1',
      question: 'Контент не будет «роботизированным»?',
    ...
    {
      id: '2',
      question: 'Безопасно ли это? Не заблокируют за автоматизацию?',
    ...
    {
      id: '3',
      question: 'Что если система даст сбой?',
    ...
    {
      id: '4',
      question: 'Можно ли использовать наши старые материалы?',
    ...
    {
      id: '5',
      question: 'Поддерживаете ли вы аналитику и отчётность?',
