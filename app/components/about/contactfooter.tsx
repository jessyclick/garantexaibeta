  ...
  return (
    <section className={styles.contactFooterSection}>
      ...
      <h2 className={styles.title}>
        ГОТОВЫ <span className={styles.accent}>К ЦИФРОВОЙ ТРАНСФОРМАЦИИ?</span>
      </h2>
      <p className={styles.subtitle + ' ' +'max-w-[600px]'}>
        Доверьте рутину искусственному интеллекту, а стратегию оставьте себе. Напишите нам, чтобы разобрать вашу задачу и помочь вам или вашему бизнесу.
      </p>
