...
const ContactFooter: React.FC<ContactFooterProps> = ({
  ...
  return (
    <section className={styles.contactFooterSection}>
      <div className={styles.decor1} />
      <div className={styles.decor2} />
      <h2 className={styles.title}>
        ГОТОВЫ НАЧАТЬ <span className={styles.accent}>СОТРУДНИЧЕСТВО?</span>
      </h2>
      ...
      <div className={styles.buttonsWrapper}>
        ...
        <CTAButton
          href={phoneUrl}
          icon={<img src="/assets/icon-call.png" alt="Документация"/>}
          variant='outline'
        >
          Позвонить
        </CTAButton>
