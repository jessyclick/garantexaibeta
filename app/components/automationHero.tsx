...
export default function HeroAutomation() {
  return (
    <section className="pt-[60px] pb-[60px] px-5 lg:pt-[120px] lg:pb-[60px] bg-[url('/assets/hero-mobile-bg.png')] lg:bg-[url('/assets/hero-bg.png')] bg-no-repeat bg-cover bg-center text-white overflow-hidden">
      <div className="max-w-[1305px] mx-auto flex flex-col lg:flex-row gap-[36px] items-center">
        
        {/* Левая часть */}
        <div className="relative z-10 w-full lg:min-w-[700px] text-center lg:text-left">
          <h1 className="text-[50px] lg:text-[98px] leading-[0.90] m-0 mb-[18px] text-white font-['Bebas_Neue',_sans-serif]">
            Автоматизация
            <br />
          ...
          <p className="max-w-[600px] mx-auto lg:mx-0 text-white mb-[32px] text-[15px] lg:text-[19px] font-['Inter',_sans-serif] text-left lg:text-left">
            Превратите ваш сайт в машину по привлечению клиентов, которая
            работает 24/7 без расходов на рекламу
          </p>

          <div className="flex flex-col sm:flex-row lg:flex-row gap-[16px] mb-[28px] justify-center lg:justify-start items-stretch">
            <div className="flex flex-col lg:flex-row font-['Inter',_sans-serif] text-[14px] lg:text-[19px] gap-[12px] items-start p-[14px_18px] border-2 border-transparent rounded-[24px] bg-origin-border [background-clip:padding-box,_border-box] bg-[linear-gradient(black,black),linear-gradient(124.35deg,#FF9F23_3.69%,#2A0C00_45.84%,#D28520_98.89%)] text-left w-full lg:max-w-[240px]">
              <span>
                Наша ИИ-система автоматически наполнит сайт сотнями SEO-статей,
                обеспечив вам органический рост
              </span>
            </div>
            <div className="flex flex-col lg:flex-row font-['Inter',_sans-serif] text-[14px] lg:text-[19px] gap-[12px] items-start p-[14px_18px] border-2 border-transparent rounded-[24px] bg-origin-border [background-clip:padding-box,_border-box] bg-[linear-gradient(black,black),linear-gradient(124.35deg,#FF9F23_3.69%,#2A0C00_45.84%,#D28520_98.89%)] text-left w-full lg:max-w-[300px]">
              <span>
                Стабильный поток заявок из Яндекс и Google в 10 раз дешевле, чем
                услуги классического SEO-агентства
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <CTAButton
              href="#"
              variant="outline"
              icon={<img src="/assets/icon_briefcase.png" alt="" />}
            >
              Посмотреть кейсы
            </CTAButton>
          </div>
