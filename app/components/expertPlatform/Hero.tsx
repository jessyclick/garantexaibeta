        ...
        <Reveal> 
          <div className={styles.left}>
            <h1 className={styles.title}>
              ...
              <br />
              <span className={styles.titleAccent}>для экспертных платформ</span>
            </h1>

            <p className={styles.lead}>
              Получайте B2B-клиентов и репутацию лидера ниши. Персональный AI-агент пишет глубокие статьи, адаптирует их под 7+ платформ и публикует за вас. Рост охватов и SEO-трафика на автопилоте.
            </p>
            ...
            <div className={styles.features}>
              <div className={`${styles.featureBox} ${styles.featureBoxFirst}`}>
                ...
                <span>Экономия до 150 000₽ в месяц на редакторах</span>
              </div>
              <div className={`${styles.featureBox} ${styles.featureBoxSecond}`}>
                <span className={styles.check}>
                  <img src="/assets/feauture-icon.png" alt="" />
                </span>
                <span>Вечный контент, который приводит лидов годами</span>
              </div>
            </div>
        ...
        <Reveal delay={0.2}>
          <div className={styles.right}>
                <div className={styles.device}>
                  <Image
                    src="/assets/expert-platform.png"
                    alt="Hero"
                    width={800}
                    height={520}
                    priority
