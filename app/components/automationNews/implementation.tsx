...
import styles from "../expertPlatform/implementation.module.scss";
...
const defaultFeatures: ImplementationFeature[] = [
  { label: "Подключение 1 платформы (Telegram / сайт)." },
  { label: "Настройка мониторинга источников (до 10 источников)." },
  { label: "Обучение промптов под ваш стиль." },
  { label: "Лимит: 2 новости в день (30 в месяц)." },
  { label: "Автопостинг." },
];

const defaultAdditionalOptions: AdditionalOption[] = [
  {
    title: "+1 новость в день → +10 000 ₽",
    description: "+15 000 ₽ за подключение новой площадки (Habr, TenChat и др.).",
  },
  {
    title: "Новая площадка → +15 000 ₽",
    description: "10 000 ₽ (пак изображений к статьям).",
  },
  {
    title: "Техподдержка → от 10 000 ₽/мес",
    description: "Индивидуальный расчет (мы ведим ваш блог полностью).",
  },
];
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        <HeaderWrapper
          kicker="#Тарифы"
          title="Соберите свой"
          titleAccent="новостной агрегатор"
        />
        ...
        <div className={styles.innerBox}>
          ...
          <div className={styles.contentWrapper}>
            ...
            <p className={styles.mainKicker}>#Старт системы</p>
            ...
            <div className={styles.gridContent}>
              ...
              <div className={styles.leftColumn}>
                ...
                <div className={styles.priceSection}>
                  <div className={styles.price}>
                    <span className={styles.priceValue}>45 000 ₽</span>
              ...
              <div className={styles.rightColumn}>
                ...
                <ul className={styles.optionsList}>
                    <h4 className={styles.columnTitle}>Опции масштабирования:</h4>
