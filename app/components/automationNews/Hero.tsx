        ...
        <Reveal> 
          <div className={styles.left}>
            <h1 className={styles.title}>
              Автоматизация
              <br />
              <span className={styles.titleAccent}>новостей</span>
            </h1>

            <p className={styles.lead}>
              ИИ мгновенно находит свежие инфоповоды, делает уникальный рерайт в вашем стиле и публикует готовые новости на ваш сайт или в соцсети в течение 5–10 минут после выхода события.
            </p>
            ...
            <div className={styles.features}>
              <div className={`${styles.featureBox} ${styles.featureBoxFirst}`}>
                ...
                <span> <strong>Полная автоматизация:</strong> от поиска до публикации</span>
              </div>
              <div className={`${styles.featureBox} ${styles.featureBoxSecond}`}>
                <span className={styles.check}>
                  <img src="/assets/feauture-icon.png" alt="" />
                </span>
                <span><strong>Рост органического трафика</strong> за счет "свежести" контента</span>
              </div>
            </div>
        ...
        <Reveal delay={0.2}>
          <div className={styles.right}>
                <div className={styles.device}>
                  <Image
                    src="/assets/automation-news.png"
                    alt="Hero"
                    width={800}
                    height={520}
                    priority
