    ...
    <section className={styles.standout}>
      <div className={styles.container}>
        <div className={styles.left}>
          <h2 >
            Станьте источником <br />
            <span> №1 в своей нише</span>
          </h2>

          <p className={styles.subtitle}>
            Пока вы читали этот текст, произошло несколько событий, которые ваши конкуренты уже публикуют. Не упускайте трафик.
          </p>
