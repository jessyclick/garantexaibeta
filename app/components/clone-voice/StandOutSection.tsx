...
import styles from "../expertPlatform/standout.module.scss";
    ...
    <section className={styles.standout}>
      <div className={styles.container}>
        <div className={styles.left}>
          <h2 >
             <span>Создавайте ролики без записи голоса</span>
             — начните уже сегодня
          </h2>

          <p className={styles.subtitle}>
            Вы можете озвучивать короткие и длинные видео, курсы и контент для соцсетей за минуты, без микрофона и без дикторов. Попробуйте ИИ-озвучку бесплатно и убедитесь сами.
          ...
          >
           Получите бесплатную демо-озвучку (до 30 сек)
          </CTAButton>
        </div>
