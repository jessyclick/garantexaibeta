...
const defaultVoiceRows: VoiceRow[] = [
  {
    ...
    samples: [
      ...
      { emotion: "Китайский", audioUrl: "/assets/voices/original-zh.mp3" },
    ],
  },
  {
    label: "КЛОН (СИИ)",
    ...
    samples: [
      ...
      { emotion: "Китайский", audioUrl: "/assets/voices/clone-zh.mp3" },
    ],
  },
];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.tableWrapper}>
          <table className={styles.voiceTable}>
            <thead>
              <tr>
                <th className={styles.emotionsHeader} colSpan={1}>
                ...
                <th className={styles.emotionsHeader} colSpan={2}>
                  <div className={styles.headerGroup}>
                    <span className={styles.headerLabel}>ЭМОЦИИ</span>
                    <div className={styles.emotionsList}>
                      <span>РАДОСТЬ</span>
                      <span>ШЁПОТ</span>
                    </div>
                ...
                <th className={styles.languagesHeader} colSpan={2}>
                  <div className={styles.headerGroup}>
                    <span className={styles.headerLabel}>ЯЗЫКИ</span>
