        ...
        <Reveal> 
          <div className={styles.left}>
            <h1 className={styles.title}>
              Клонирование голоса
              <br />
              <span className={styles.titleAccent}>и ИИ-озвучка под ключ</span>
            </h1>

            <p className={styles.lead}>
              Вы пишете текст — телеграмм бот или мы выдаём студийный звук для коротких и длинных видео, курсов и озвучек. Идеально для Reels, Short и длинных видео на YouTube
            </p>
            ...
            <div className={styles.features}>
              <div className={`${styles.featureBox} ${styles.featureBoxFirst}`}>
                ...
                <span>Озвучка любого ролика — за 1 минуту</span>
              </div>
              <div className={`${styles.featureBox} ${styles.featureBoxSecond}`}>
                <span className={styles.check}>
                  <img src="/assets/feauture-icon.png" alt="" />
                </span>
                <span>Клон вашего голоса — за несколько минут</span>
              </div>
            </div>
