...
export default function ServicesSectionTwo() {
  return (
    <section className="py-[56px] px-5 text-white">
      {/* Использование lg:flex-row-reverse заменяет .containerTwo */}
      <div className="max-w-[1305px] mx-auto flex flex-col lg:flex-row-reverse gap-[28px] items-start justify-center">
        ...
        <div className="w-full lg:max-w-[42rem]">
          ...
          <h3 className="text-white font-['Bebas_Neue',_sans-serif] text-[2.8125rem] font-normal leading-[2.375rem] mb-[0.6rem] m-0">
            Виртуальная примерка
          </h3>
          <p className="text-white font-['Inter',_sans-serif] text-[0.9375rem] font-light leading-[1.37525rem] mb-[18px] m-0">
            Каталожная съемка без моделей, студий и визажистов.
          </p>

          {/* Карточка "Как мы работаем" */}
          <div className="border border-transparent rounded-[12px] p-[18px_22px] lg:p-[2.5rem_4.4rem] mb-[18px] bg-origin-border [background-clip:padding-box,_border-box] bg-[linear-gradient(163deg,#000_9.05%,#212121_52.54%,#000_88.01%),linear-gradient(124.35deg,#FE7905_3.69%,#2A0C00_45.84%,#A93301_98.89%)]">
            ...
            <ol className="relative list-none p-0 m-0 flex flex-col gap-[20px]">
              {/* Пунктирная линия */}
              <div className="absolute left-[17px] top-0 w-[1px] h-[240px] bg-[url('/assets/line.png')] bg-contain w-[1px] h-[calc(100%-40px)]"></div>
              ...
              <li className="relative z-10 flex gap-[12px] items-start">
                ...
                <div>
                  ...
                  <div className="text-white font-['Inter',_sans-serif] text-[14px] lg:text-[1.08169rem] font-light leading-[1.4875rem]">
                    Вы присылаете фото одежды (можно на вешалке/манекене) и, если есть, фото модели.
                  </div>
                </div>
              </li>
              ...
              <li className="relative z-10 flex gap-[12px] items-start">
                ...
                <div>
                  ...
                  <div className="text-white font-['Inter',_sans-serif] text-[14px] lg:text-[1.08169rem] font-light leading-[1.4875rem]">
                    Мы «надеваем» ваш товар на модель. Корректируем посадку, складки, тени и фактуру ткани. Результат неотличим от реального фото.
                  </div>
                </div>
              </li>
              ...
              <li className="relative z-10 flex gap-[12px] items-start">
                ...
                <div>
                  <strong className="text-white font-['Inter',_sans-serif] text-[15px] lg:text-[1.2845rem] font-bold leading-[1.4875rem] block mb-1">
                    Нет модели? Не проблема!
                  </strong>
                  <div className="text-white font-['Inter',_sans-serif] text-[14px] lg:text-[1.08169rem] font-light leading-[1.4875rem]">
                    Мы сгенерируем уникальную виртуальную модель (любой пол, возраст, раса) специально под ваш бренд.
                  </div>
                </div>
              </li>
            </ol>
          ...
          <div className="flex flex-col gap-[1rem]">
            {/* Блок Стоимость */}
            <div className="flex-1 lg:flex-[1_1_320px] border border-transparent rounded-[12px] p-[18px_22px] lg:p-[2.5rem_4.4rem] text-[#eafcf6] bg-origin-border [background-clip:padding-box,_border-box] bg-[linear-gradient(163deg,#001613_9.43%,#00302B_52.39%,#001613_87.36%),linear-gradient(124.35deg,#FE7905_3.69%,#2A0C00_45.84%,#A93301_98.89%)]">
              ...
              <div className="flex justify-between items-start lg:items-center p-[0.6rem_0.8rem] border border-[#007568] bg-[#003E37] rounded-[0.81125rem]">
                <div className="flex flex-col gap-2 max-w-[220px] sm:max-w-none">
                  <span className="font-bold text-[14px] lg:text-base">Тест-драйв: 1 демо-ролик (15 сек)</span>
                  <div className="text-white font-['Inter',_sans-serif] text-[14px] lg:text-[1.08169rem] font-light leading-[1.4875rem] max-w-[380px]">
                    Подбор типажа (пол, возраст) + Фон + 3-5 ракурсов
                  </div>
                </div>
                <strong className="text-[14px] lg:text-base whitespace-nowrap">1 500 ₽</strong>
              </div>
              
              {/* Второй активный блок со списком */}
              <div className="flex flex-col mt-[10px] p-[0.6rem_0.8rem] border border-[#007568] bg-[#003E37] rounded-[0.81125rem]">
                <div className="flex flex-col gap-2 mb-2">
                  <span className="font-bold text-[14px] lg:text-base">Надеть одежду на модель (Вашу или Нашу):</span>
                </div>
                <div className="flex justify-between items-center py-[0.6rem] lg:p-[0.6rem_0.8rem] border-b border-[rgba(255,255,255,0.03)] text-[14px] lg:text-base">
                  <span>3–5 фото</span>
                  <strong>750 ₽ / шт</strong>
                </div>
                <div className="flex justify-between items-center py-[0.6rem] lg:p-[0.6rem_0.8rem] border-b border-[rgba(255,255,255,0.03)] text-[14px] lg:text-base">
                  <span>5–15 фото</span>
                  <strong>650 ₽ / шт</strong>
                </div>
                <div className="flex justify-between items-center py-[0.6rem] lg:p-[0.6rem_0.8rem] border-b border-[rgba(255,255,255,0.03)] text-[14px] lg:text-base">
                  <span>15–30 фото</span>
                  <strong>500 ₽ / шт</strong>
                </div>
                <div className="flex justify-between items-center py-[0.6rem] lg:p-[0.6rem_0.8rem] border-b border-[rgba(255,255,255,0.03)] text-[14px] lg:text-base">
                  <span>30+ фото</span>
                  <strong>375 ₽ / шт</strong>
                </div>
              </div>
            </div>

            {/* Блок Опции */}
            <div className="border border-transparent rounded-[12px] p-[18px_22px] lg:p-[2.5rem_4.4rem] text-[#ffd7a8] bg-origin-border [background-clip:padding-box,_border-box] bg-[linear-gradient(157.79deg,#201200_5.07%,#422602_53.78%,#201200_93.52%),linear-gradient(124.35deg,#FE7905_3.69%,#2A0C00_45.84%,#A93301_98.89%)]">
              <div className="pl-[0.8rem] text-white font-['Bebas_Neue',_sans-serif] text-[20px] lg:text-[1.82531rem] font-normal leading-[2.56894rem] mb-3">
              ...
              <div className="flex justify-between items-center p-[0.6rem_0.8rem] border-b border-dashed border-[rgba(255,255,255,0.03)] gap-4 text-[14px] lg:text-base">
                <div className="flex items-center gap-[8px]">
                  <img className="w-[24px] h-[24px]" src="/assets/icon_cam.png" alt="" />
                  <span className="max-w-[290px]">Полноценный ролик (15 сек), где модель двигается в вашей одежде</span>
                </div>
